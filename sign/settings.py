...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'crosschain_swap_sign'),
        'USER': os.getenv('POSTGRES_USER', 'crosschain_swap_sign'),
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'crosschain_swap_sign'),
